        ...
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-6xl max-h-[90vh] overflow-hidden">
            <div class="bg-gradient-to-r from-purple-600 to-blue-600 px-6 py-4 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <!-- Developer Button: Author Face Identity -->
                    <button title="Developer Info" @click.stop="toggleDev()" 
                        ...
                        class="modal-action-btn overflow-hidden" style="width:44px;height:44px;border-radius:12px;display:flex;align-items:center;justify-content:center;transition:all 0.3s cubic-bezier(0.4, 0, 0.2, 1);">
                        <img src="https://github.com/Maijied.png" class="w-full h-full object-cover larvae-wiggle" style="filter: contrast(1.1) brightness(1.1);">
                    </button>

                    <!-- Settings Button: Indigo Configuration Identity -->
