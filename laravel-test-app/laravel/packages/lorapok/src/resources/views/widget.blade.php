            ...
            <div class="bg-gradient-to-r from-purple-600 to-blue-600 px-6 py-4 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button title="Developer Info" @click.stop="toggleDev()" 
                        :class="showDevInfo ? 'bg-amber-500/30 ring-2 ring-amber-400/50 scale-105' : 'bg-white/10 hover:bg-amber-500/20'" 
                        class="modal-action-btn" style="width:44px;height:44px;border-radius:12px;display:flex;align-items:center;justify-content:center;transition:all 0.3s cubic-bezier(0.4, 0, 0.2, 1);">
                        <svg viewBox="0 0 48 48" class="larvae-wiggle" style="width:22px;height:22px; filter: drop-shadow(0 0 8px rgba(245, 158, 11, 0.4))">
                    ...
                    <button title="Settings" @click.stop="toggleSettings()" 
                        :class="openSettings ? 'bg-amber-500/30 ring-2 ring-amber-400/50 scale-105' : 'bg-white/10 hover:bg-amber-500/20'" 
                        class="modal-action-btn" style="width:44px;height:44px;border-radius:12px;display:flex;align-items:center;justify-content:center;transition:all 0.3s cubic-bezier(0.4, 0, 0.2, 1);">
                        <svg viewBox="0 0 24 24" class="larvae-spin" style="width:18px;height:18px; filter: drop-shadow(0 0 8px rgba(245, 158, 11, 0.4))">
